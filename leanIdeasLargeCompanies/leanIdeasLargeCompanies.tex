...
% a long march of death due to bureaucracy and people clinging onto it.
% The project can gradually hog more and more resources until it starts draining resources from the main revenue stream of the company.
...
%would be no more cash to support the company which would have to inevitably close down. Large companies have the added danger of that project attracting resources from main products and can keep the illusion of sunken costs for longer.
...
%However, there is a balance to be had between risk and reward.
...
% i'd say it's about risk and reward. Lean methodology is quite risky and if a big company already has loads to do in its segment it's not worth the risk of switching to a new one
